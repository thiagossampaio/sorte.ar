...
+function ($) { "use strict"; 
  ...
  Pongstgrm.defaults = {
    ...
    , column:           "col-xs-12 col-sm-12 col-md-3 col-lg-3"
  ...
  Pongstgrm.prototype.template = {
    loadmore: function (options) {
      var _load  = '<div class="row"><div class="col-xs-12">'
    ...
    , thumb: function (options) {
        var _thumbnail  = '<div class="'+ options.dflt.column +'">'
          ...
          options.dflt.timestamp !== false ?
            ...
            _thumbnail += '   <a href="'+ contextPath +'/sortear.html?accessToken='+ instagram.accessToken +'&media='+ options.data.id+'" id="triggr-'+ options.data.id +'">'
